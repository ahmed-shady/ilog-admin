...
import { loginWithEmail } from '@app/api/AuthService';
        ...
        <div className="card-body">
          ...
          <div className="social-auth-links text-center mt-2 mb-3">
            <Button
              ...
              onClick={() => {window.location.href = "http://www.ilog-app.com";
            }}
            >
              <i className="fas fa-external-link-square-alt	 mr-2" />
              {t('login.button.redirect', { what: 'ILog' })}
            </Button>
          </div>
          <p className="mb-1">
